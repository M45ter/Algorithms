...
*/
    ...
    *  as an argument. It can handle action keys
     ...
     */
    public static void main(String[] args) {
        edu.princeton.cs.algs4.StdDraw.square(0.2, 0.8, 0.1);
        edu.princeton.cs.algs4.StdDraw.filledSquare(0.8, 0.8, 0.2);
        edu.princeton.cs.algs4.StdDraw.circle(0.8, 0.2, 0.2);

        edu.princeton.cs.algs4.StdDraw.setPenColor(edu.princeton.cs.algs4.StdDraw.BOOK_RED);
        edu.princeton.cs.algs4.StdDraw.setPenRadius(0.02);
        edu.princeton.cs.algs4.StdDraw.arc(0.8, 0.2, 0.1, 200, 45);
