...
public class Polynomial {
     ...
     */
    public edu.princeton.cs.algs4.Polynomial plus(edu.princeton.cs.algs4.Polynomial that) {
        edu.princeton.cs.algs4.Polynomial poly = new edu.princeton.cs.algs4.Polynomial(0, Math.max(this.degree, that.degree));
     ...
     * @return the polynomial whose value is {@code (this(x) - that(x))}
     */
    public edu.princeton.cs.algs4.Polynomial minus(edu.princeton.cs.algs4.Polynomial that) {
        edu.princeton.cs.algs4.Polynomial poly = new edu.princeton.cs.algs4.Polynomial(0, Math.max(this.degree, that.degree));
        for (int i = 0; i <= this.degree; i++) poly.coef[i] += this.coef[i];
        for (int i = 0; i <= that.degree; i++) poly.coef[i] -= that.coef[i];
        poly.reduce();
     ...
     * @return the polynomial whose value is {@code (this(x) * that(x))}
     */
    public edu.princeton.cs.algs4.Polynomial times(edu.princeton.cs.algs4.Polynomial that) {
        edu.princeton.cs.algs4.Polynomial poly = new edu.princeton.cs.algs4.Polynomial(0, this.degree + that.degree);
     ...
     */
    public edu.princeton.cs.algs4.Polynomial compose(edu.princeton.cs.algs4.Polynomial that) {
        edu.princeton.cs.algs4.Polynomial poly = new edu.princeton.cs.algs4.Polynomial(0, 0);
        for (int i = this.degree; i >= 0; i--) {
            edu.princeton.cs.algs4.Polynomial term = new edu.princeton.cs.algs4.Polynomial(this.coef[i], 0);
    ...
    public boolean equals(Object other) {
        ...
        edu.princeton.cs.algs4.Polynomial that = (edu.princeton.cs.algs4.Polynomial) other;
     ...
     */
    public edu.princeton.cs.algs4.Polynomial differentiate() {
        if (degree == 0) return new edu.princeton.cs.algs4.Polynomial(0, 0);
        edu.princeton.cs.algs4.Polynomial poly = new edu.princeton.cs.algs4.Polynomial(0, degree - 1);
     ...
     *         argument point
     */
    public int compareTo(edu.princeton.cs.algs4.Polynomial that) {
    ...
    public static void main(String[] args) {
        edu.princeton.cs.algs4.Polynomial zero = new edu.princeton.cs.algs4.Polynomial(0, 0);

        edu.princeton.cs.algs4.Polynomial p1   = new edu.princeton.cs.algs4.Polynomial(4, 3);
        edu.princeton.cs.algs4.Polynomial p2   = new edu.princeton.cs.algs4.Polynomial(3, 2);
        edu.princeton.cs.algs4.Polynomial p3   = new edu.princeton.cs.algs4.Polynomial(1, 0);
        edu.princeton.cs.algs4.Polynomial p4   = new edu.princeton.cs.algs4.Polynomial(2, 1);
        edu.princeton.cs.algs4.Polynomial p    = p1.plus(p2).plus(p3).plus(p4);   // 4x^3 + 3x^2 + 1

        edu.princeton.cs.algs4.Polynomial q1   = new edu.princeton.cs.algs4.Polynomial(3, 2);
        edu.princeton.cs.algs4.Polynomial q2   = new edu.princeton.cs.algs4.Polynomial(5, 0);
        edu.princeton.cs.algs4.Polynomial q    = q1.plus(q2);                     // 3x^2 + 5


        edu.princeton.cs.algs4.Polynomial r    = p.plus(q);
        edu.princeton.cs.algs4.Polynomial s    = p.times(q);
        edu.princeton.cs.algs4.Polynomial t    = p.compose(q);
        edu.princeton.cs.algs4.Polynomial u    = p.minus(p);
